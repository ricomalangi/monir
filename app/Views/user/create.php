            ...
            <form action="<?= base_url('user/add') ?>" method="POST">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" name="nama_lengkap" value="<?= set_value('nama_lengkap') ?>" class="form-control" placeholder="Nama Lengkap">
                    </div>
                    <div class="form-group col-md-12">
                        <label>No Telepon</label>
                        <input type="number" name="no_hp" value="<?= set_value('no_hp') ?>" class="form-control" placeholder="081xxx">
                    </div>
