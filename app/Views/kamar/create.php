        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Kamar Add</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            <form action="<?= base_url('kamar/add') ?>" method="POST">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" name="nama_kamar" value="<?= set_value('nama_kamar') ?>" class="form-control" placeholder="Nama Kamar">
                    </div>
                    <div class="form-group col-md-12">
                        ...
                        <select name="id_user" class="form-control">
                            ...
                            <?php foreach($users as $user): ?>
                                <option value="<?= esc($user['id']) ?>"><?= esc($user['nama_lengkap']) ?></option>
                            <?php endforeach ?>
                        </select>
                    </div>
                </div>
